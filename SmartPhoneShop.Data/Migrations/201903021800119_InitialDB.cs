    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ProductID, t.ShipmentID, t.DateReceipt })
            ...
            CreateTable(
                ...
                {
                    ID = c.Int(nullable: false, identity: true),
                    ProviderName = c.String(nullable: false, maxLength: 250),
                    ProviderAddress = c.String(nullable: false, maxLength: 250),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GoodReceipts", "ShipmentID", "dbo.Shipments");
            DropForeignKey("dbo.GoodReceipts", "ProductID", "dbo.Products");
            ...
            DropIndex("dbo.GoodReceipts", new[] { "ShipmentID" });
            DropIndex("dbo.GoodReceipts", new[] { "ProductID" });
