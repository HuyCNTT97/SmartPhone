...
namespace SmartPhoneShop.Web.API
{
    ...
    public class SuppostOnlineController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                var model = _suppostOnlineService.GetAll();

                var responseData = Mapper.Map<IEnumerable<SuppostOnline>, IEnumerable<SuppostOnlineViewModel>>(model);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                var model = _suppostOnlineService.GetByID(id);

                var responseData = Mapper.Map<SuppostOnline, SuppostOnlineViewModel>(model);
